...
class CacheService:
    ...
    def __init__(self):
        ...
        self.npc_shops: List[Any] = []
        self.organizations: List[Any] = []
        self.character_stories: List[Any] = []
        self.map_texts: List[Any] = []
        self.adventurer_guild_tasks: List[Any] = []
        self.foods: List[Any] = []
    ...
    def add_item(self, item: Any, item_type: str):
        ...
        type_mapping = {
            ...
            '6_敌人': 'enemies',
            '49_动物': 'animals',
            '13_背包': 'inventory_items',
            '20_NPC&商店': 'npc_shops',
            '21_食物': 'foods',
            '255_组织': 'organizations',
            '261_角色逸闻': 'character_stories',
            '251_地图文本': 'map_texts',
            '55_冒险家协会': 'adventurer_guild_tasks',
            '54_秘境': 'domains',
            '211_装扮': 'outfits',
        }
