...
4. If the local resource does not cover a concrete Genshin detail, use the wiki helper. It defaults to online BWIKI; use `--source genshin-story` only when a local GenshinStory cache is available:
